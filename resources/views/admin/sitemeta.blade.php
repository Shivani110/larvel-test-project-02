    ...
    <div class="nk-block nk-block-lg">
        <div class="card card-bordered">
            <div class="card-inner">
                ...
                @if(isset($sitemeta))
                    <form action="{{ url('admin-dashboard/updatesitemeta') }}" method="POST" class="gy-3">
                    @csrf
                @else
                    <form action="{{ url('admin-dashboard/createsite') }}" method="POST" class="gy-3">
                @endif
                    @csrf
                    ...
                    <div class="row g-3">
                        <div class="col-lg-7 offset-lg-5">
                            ...
                            @else
                                <button type="submit" class="btn btn-lg btn-primary">Add Site Meta</button>
                            @endif
                            </div>
                        </div>
                    </div>
