        ...
        <div class="card card-bordered">
            <div class="card-inner">
                ...
                @if(isset($otherservice))
                    <form action="{{ url('admin-dashboard/updateservices') }}" method="POST" class="gy-3">
                    @csrf
                @else
                    <form action="{{ url('admin-dashboard/createservices') }}" method="POST" class="gy-3">
                @endif
                    @csrf
                        ...
                        <div class="col-lg-7">
                            <div class="form-group">
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" id="title" name="title" value="{{ $otherservice->title ?? '' }}" placeholder="Enter title here">
                                </div>
                                @error('title')
                                {{ $message }}
                                @enderror
                    ...
                    <div class="row g-3 align-center">
                        <div class="col-lg-5">
                            <div class="form-group">
                                ...
                                <span class="form-note">Please select the Category of your Other Services.</span>
                            </div>
                        </div>
                        <div class="col-lg-7">
                            @if($otherservice ?? '')
                                @foreach($category as $ctg)
                                    @if($otherservice->category == $ctg->id)
                                                    ...
                                                    <div class="card-inner-group">
                                                        <div class="card-inner p-0">
                                                            <div class="nk-tb-list">
                                                                ...
                                                                @if($otherservice ?? '')
                                                                <?php $pID = json_decode($otherservice->publication); ?>
                    ...
                    <input type="hidden" name="id" id="id" value="{{ $otherservice->id ?? ''}}">
                    <div class="row g-3">
                        <div class="col-lg-7 offset-lg-5">
                            <div class="form-group mt-2">
                            @if(isset($otherservice))
                                <button type="submit" class="btn btn-lg btn-primary">Update Other Services</button>
                            @else
                                <button type="submit" class="btn btn-lg btn-primary">Add Other Services</button>
                            @endif
                            </div>
                        </div>
                    </div>
