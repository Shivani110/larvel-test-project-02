                    ...
                    <div class="nk-block nk-block-lg">
                        <div class="nk-block-head">
                            <div class="nk-block-head-content">
                                <h4 class="title nk-block-title">Bundle Category</h4>
                            </div>
                        </div>
                                    ...
                                    <tr class="tb-tnx-item" id="category{{ $data->id }}">
                                        ...
                                        <td class="tb-tnx-info c-name{{ $data->id }}">
                                            <div class="tb-tnx-desc">
                                                <input type="text" data-id="{{ $data->id }}" id="cname{{$data->id}}" class="" value="{{ $data->category_name }}" disabled="" style="border: none; background: transparent;">
                                            </div>
                                        </td>
                                        <td>
